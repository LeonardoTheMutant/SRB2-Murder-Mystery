...
| <code>**V_DrawTextPatch**(*drawer* v, *int* x, *int* y, *string[]* data)</code>                                                                 | nil               | Draws a patch using the `data` in a text form. `data` is a table of strings, each table element represents a row and each symbol in `data[row]` corresponds to the color value from the SRB2's palette.                                                                                                                                                                                                                                                                                                                                    |
...
| -------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------- |
| `version`      | *string*   | Version number of the build                                                                                                                                              | `"1.0-ALPHA"`                                                                                                          |
