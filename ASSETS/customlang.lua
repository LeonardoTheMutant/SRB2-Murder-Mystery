...
local language={ --Language must be a table variable, you can name the variable as you like.
	...
	["MMHELP"]={ --MMHELP command's text
		["MAIN"]={ --When no page is specified
			...
			" * \x85Murderer\x80 - true criminal. He has to kill everyone, but is limited to shoot Red (Normal) and Infinite Rings only;",
			" * \x84Sheriff\x80  - his task is to find and eliminate the \x85Murderer(s)\x80. Sheriffs may use every Weapon Ring available on the map;",
			" * \x83Innocent\x80 - completely armless civilian, he must avoid being killed but also can help to find the \x85Murderer\x80.",
			"\nThat's all basic information requiered to start playing, if you still miss something or want to know more use these console commands:",
			...
			"\nYou might also want to use \x87MMLANG\x80 to change the Language inside MM"
		},["GAME"]={ --MMHELP GAME
			...
			"\n* If someone shot you down with his ring you become\x8F Dead\x80. Players with this state cannot respawn and talk globaly to players that are still alive, their messages are visible only to the other\x8F dead\x80 players.",
			"You can't \x87SAYTO\x80 or PM the player who's alive as\x8F DEAD\x80 as well.",
			...
			"* Being AFK is a war crime. If you will be inactive for a long time the game will kick you (only if you're alive).",
			"* Do not rename yourself WHILE IN THE GAME - the game is strict about this and will\x85 auto-close\x80 your SRB2 if try doing this. If you need to rename wait for the Intermission screen to do it.",
			...
			"When player sends the message that contains some special words or phrases a specified Sound Emoji will play with the message.",
	...
	["ROLE_GET"]={
		...
		"You're an \x83Innocent\x80! Hide and help the sheriff find the murderer." --Innocent
	},
	-- Text when someone left or died in midgame and you was lucky enough to get their role
	["NEWROLE_GET"]={
		"\x87Life made a \x85Murderer\x87 from you, \x85now go kill everyone.", --Murderer
		"\x87The Universe made you the new \x84Sheriff\x87! It's now your job to\x84 eliminate all Murderers\x87!", --Sheriff
		"\x87".."All defenders left but the Universe selected you as a new \x82Hero\x87! It's your chance to save the day!" --HERO
	},
	-- Teammate hit, if you accidentaly hit your teammate both of you will get the notice
	["TEAMMATE_HIT"]={
		"Hey, this guy is your teammate, don't try to kill him again", --for the guy who attacked
		"Your teammate hit you, don't try to get revenge on him" --for the victim
	},
	-- Murderer killed annouce
	["MURD_KILLED"]={
		"\x85Murderer\x87", --beginning of the string
		"\x80is eliminated!" --ending
	},
	-- Sheriff killed announce
	["SHERI_KILLED"]={
		"\x84Sheriff\x87",
		"\x80is murdered! Innocents can pick up his\x84 Emerald\x80!", --ending 1 (Regular death)
		"\x80is murdered!" --ending 2 (Didn't drop the emerald)
	},
	-- Hero killed announce
	["HERO_KILLED"]={
		"\x82Hero\x87", --beginning
		"\x80is murdered!" --ending
	},
	...
	["ONE_LEFT"]={
		...
		"One of the \x82Heros\x80 left!" --Hero
	},
	-- "Last player with [role] left the game!"
	["LAST_LEFT"]={
		"Last \x85Murderer\x80 left!", --Murderer
		"Last \x84Sheriff\x80 left!", --Sheriff
		"Last \x83Innocent\x80 left!", --Innocent
		"Last \x82Hero\x80 left!" --Hero
	},
	-- "Player with [role] left the game, some Innocent recieved his role!"
	["REPLACE_LEFT"]={
		"\x85Murderer\x80 left! Some \x83Innocent\x80 took his role!", --Murderer
		"\x84Sheriff\x80 left! Some \x83Innocent\x80 took his role!", --Sheriff
		"\x82Hero\x80 left! Some \x83Innocent\x80 took his role!" --Hero
	},
	-- Global chat end round messages
	["ENDROUND"]={
		"Everyone are murdered, \x85Murderers\x80 win!", --Murderers killed everyone (regular win)
		"All murderers are eliminated,\x83 Civilians\x80 win!", --Sheriffs, Innocents (and Heros) eliminted all Murderers (regular win)
		"\x85Murderers\x80 win because \x84Sheriff\x80 murdered the last Innocent!", --Sheriff killed the last Innocent
		"\x82Hero\x80 have chosen to kill the last Innocent. \x85Murderers\x80 Win!", --Hero killed the last Innocent
		"All Sheriffs and Heros are dead, \x85Murderers\x80 win!" --Murderers killed all Sheriffs and Heros, but not Innocents (Murderers win)
	},
	-- Special PM notifications
	["CHAT"]={
		"is alive, message not sent", --When DEAD player attempts to PM the ALIVE player (shown in console)
		"You're sending too much messages, please wait", --PM when player sends too much messages in one period (shown in console)
		"You can't just become\x8F dead\x80 to spectate!" --Trying to use "SPECTATE" button from pause menu (shown in chat)
	},
	...
	["HUD_MIDJOIN"]={
		"You joined \x84mid-round\x80, please wait for the new round to play"
	},
